...
VALUES (1, 'ealpine0', 'Erhart Alpine', 'b8eYD1a7R44', 'F', '1949-07-07', 68, 'ealpine0@squarespace.com'),
...
VALUES (1, 'Marlo', 'O''Malley', 'M', '1958-9-21', 1),
       (2, 'Nolan', 'Meneyer', 'M', '1961-4-29', 6),
       (3, 'Tarah', 'McWaters', 'F', '1954-5-22', 9),
       (4, 'Bernetta', 'Bigley', 'F', '1979-10-18', 2),
       (5, 'Gregory', 'Stithe', 'M', '1952-6-25', 5),
       (6, 'Bord', 'Hambleton', 'M', NULL, 8),
       (7, 'Humphrey', 'Tamblyn', 'M', '1941-3-26', 6),
       (8, 'Dinah', 'Zini', 'F', '1950-9-8', 10),
       (9, 'Eustace', 'Sharpling', 'M', '1956-10-29', 1),
       (10, 'Shannon', 'Partridge', 'M', '1952-2-14', 1),
       (11, 'Nancey', 'Heintsch', 'F', '1967-8-20', 3),
       (12, 'Niki', 'Stranaghan', 'M', '1969-11-26', 9),
       (13, 'Dick', 'Wentworth', 'M', '1983-4-29', 4),
       (14, 'Ives', 'McNeigh', 'M', '1952-11-15', 1),
       (15, 'Leonardo', 'Shopcott', 'M', '1939-1-15', 6),
       (16, 'Howard', 'Lovelady', 'M', '1969-6-6', 5),
       (17, 'Bron', 'Ledur', 'M', '1996-11-26', 10),
       (18, 'Adelind', 'Benns', 'F', '1935-11-23', 10),
       (19, 'Imogen', 'Burnup', 'F', '1952-5-8', 3),
       (20, 'Eldon', 'Gaze', 'M', '1947-8-24', 5),
       (21, 'Patsy', 'McLenahan', 'F', NULL, 10),
       (22, 'Jeane', 'Salisbury', 'F', '1967-9-13', 5),
       (23, 'Tiena', 'Ritchard', 'F', '1985-4-18', 3),
       (24, 'Hakim', 'Guilaem', 'M', '1963-4-9', 9),
       (25, 'Corny', 'Pickthall', 'M', '1979-12-18', 2),
       (26, 'Tam', 'Kornel', 'M', '1995-10-3', 9),
       (27, 'Abby', 'Brettoner', 'F', '1992-4-16', 9),
       (28, 'Galven', 'Moston', 'M', '1945-3-20', 5),
       (29, 'Stefa', 'Jakubovski', 'F', '1947-1-10', 2),
       (30, 'Hewet', 'Juschke', 'M', '1997-12-26', 7);

INSERT INTO `categories`(`id`, `name`, `department_id`)
VALUES (1, 'Snow Removal', 5),
       (2, 'Recycling', 10),
...
VALUES (1, 1, 4, '2017-04-13', NULL, 'Stuck Road on Str.14', 14, 5),
