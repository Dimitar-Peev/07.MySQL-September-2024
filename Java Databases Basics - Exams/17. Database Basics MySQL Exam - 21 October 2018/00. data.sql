...
INSERT INTO `spaceports` (`id`, `name`, `planet_id`)
VALUES (1, 'Miracle Colony', 15),
       (2, 'Horus Colony', 18),
       (3, 'Torus Base', 5),
       (4, 'Rebus Station', 10),
       (5, 'Zeus Colony', 5),
...
INSERT INTO `colonists` (`id`, `first_name`, `last_name`, `ucn`, `birth_date`)
VALUES (1, 'Llywellyn', 'Gethouse', '4339438960', '1970-07-17'),
...
INSERT INTO `spaceships` (`id`, `name`, `manufacturer`, `light_speed_rate`)
VALUES (1, 'USS Templar', 'Oyoba', 1),
...
INSERT INTO `journeys` (`id`, `journey_start`, `journey_end`, `purpose`, `destination_spaceport_id`, `spaceship_id`)
VALUES (1, '2019-02-09 17:02:46', '2049-04-20 22:39:54', 'Educational', 25, 10),
...
VALUES (1, '8146587399', 'Trooper', 46, 10),
