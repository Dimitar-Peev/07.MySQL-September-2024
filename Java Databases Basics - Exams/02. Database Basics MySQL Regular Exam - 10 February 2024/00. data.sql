...
INSERT INTO `countries` (`name`, `country_code`, `continent_id`)
...
INSERT INTO `positions` (`id`, `name`, `description`, `is_dangerous`)
VALUES (1, 'Botanist',
...
INSERT INTO `countries_preserves` (`country_id`, `preserve_id`)
VALUES (1, 2),
       (2, 4),
       (2, 8),
       (2, 9),
