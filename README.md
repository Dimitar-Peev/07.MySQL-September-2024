...
<p>Databases are the standard way of using dynamic information in all applications, making them an indispensable part of almost every application. The database basics course will introduce students to one of the most widely used database management systems (DBMS) in the development of historical applications - MySQL. Training participants acquire skills for working with relational databases, and will focus on basic functionalities such as working with tables, grouping functions, transactions, procedures and others. This course lays the foundations of working with databases, making it easier to use them in real-world applications, as well as understand them.</p>